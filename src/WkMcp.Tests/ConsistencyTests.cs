...
public class ConsistencyTests
{
    private static readonly Type[] ToolClasses =
        { typeof(WolvenKitTools), typeof(ModdingTools), typeof(SceneTools), typeof(ProbeTools), typeof(LiveTools) };
    ...
    public void Every_tool_declares_its_annotations_explicitly()
    {
        ...
        foreach (var file in new[] { "WolvenKitTools.cs", "ModdingTools.cs", "AssetInspectionTools.cs", "GameplayInspectionTools.cs", "SceneTools.cs", "ProbeTools.cs", "LiveTools.cs" })
