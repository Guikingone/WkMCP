...
(`cp77tools`) as **151 tools** an agent (Claude) can call — so you steer Cyberpunk
...
The server exposes **151 tools** (115 offline + 36 `live_*`), **10 prompts** and **4 resources**.
...
- **[docs/TOOLS.md](docs/TOOLS.md)** — exhaustive reference of the 151 tools + 10 prompts + 4 resources (parameters included).
...
```
wkmcp/
├── src/WkMcp/         C# / .NET 8 MCP server (151 tools, 10 prompts, 4 resources)
